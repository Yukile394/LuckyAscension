...
public class ModVillagers {
    ...
    public static final RegistryObject<PoiType> LUCK_MASTER_POI = POI_TYPES.register(
        "luck_master_poi",
        () -> new PoiType(
            // DÜZELTME (Hata 5): Set.of() yerine Set.copyOf() kullan.
            // Set.of() bazı Forge versiyonlarında immutable set kontrolünden geçemiyor.
            // Set.copyOf() her zaman yeni bir immutable kopya oluşturur — daha güvenli.
            Set.copyOf(Set.of(Blocks.BREWING_STAND.defaultBlockState())),
            1, 1
        )
    );
